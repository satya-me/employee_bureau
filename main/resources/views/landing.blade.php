...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="landing/assets/images/favicon.svg" type="image/svg" />
...
<body>
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="navbar-btn d-none d-sm-inline-block">
                            ...
                            <a class="ud-main-btn ud-white-btn" href="{{ url('/register') }}">
                                Sign Up
                            </a>
                        </div>
                    </nav>
                ...
                <div class="col-lg-12">
                    <div class="ud-hero-content wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <p class="ud-hero-desc">
                            We cover almost 1 million fraud database across India, To Help you Get the right employee
                            for your business.
                        </p>
                    ...
                    <div class="ud-hero-image wow fadeInUp" data-wow-delay=".25s">
                        ...
                        <img src="landing/assets/images/hero/dotted-shape.svg" alt="shape"
                            class="shape shape-1" />
                        <img src="landing/assets/images/hero/dotted-shape.svg" alt="shape"
                            class="shape shape-2" />
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ud-section-title">
                        <span>Features</span>
                        <h2>Fraud From All Indrustries</h2>
                        <p>
                            We cover almost 1 million fraud database across India, To Help you Get the right employee
                            for your business.
                        </p>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="ud-single-feature wow fadeInUp" data-wow-delay=".1s">
                        ...
                        <div class="ud-feature-content">
                            <h3 class="ud-feature-title">Money Related Frauds</h3>
                ...
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="ud-single-feature wow fadeInUp" data-wow-delay=".15s">
                        ...
                        <div class="ud-feature-content">
                            <h3 class="ud-feature-title">Integrity Related Frauds</h3>
                            <p class="ud-feature-desc">
                                Lorem Ipsum is simply dummy text of the printing and industry.
                            </p>
                            <a href="javascript:void(0)" class="ud-feature-link">
                ...
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="ud-single-feature wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="ud-feature-content">
                            <h3 class="ud-feature-title">Money Package Related</h3>
                            <p class="ud-feature-desc">
                                Lorem Ipsum is simply dummy text of the printing and industry.
                            </p>
                            <a href="javascript:void(0)" class="ud-feature-link">
                ...
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="ud-single-feature wow fadeInUp" data-wow-delay=".25s">
                        ...
                        <div class="ud-feature-content">
                            <h3 class="ud-feature-title">Duel Employement Alert</h3>
                            <p class="ud-feature-desc">
                                Lorem Ipsum is simply dummy text of the printing and industry.
                            </p>
                            <a href="javascript:void(0)" class="ud-feature-link">
    ...
    <footer class="ud-footer wow fadeInUp" data-wow-delay=".15s">
        <div class="shape shape-1">
            <img src="landing/assets/images/footer/shape-1.svg" alt="shape" />
        </div>
        <div class="shape shape-2">
            <img src="landing/assets/images/footer/shape-2.svg" alt="shape" />
        </div>
        <div class="shape shape-3">
            <img src="landing/assets/images/footer/shape-3.svg" alt="shape" />
        </div>
                            ...
                            <ul class="ud-widget-brands">
                                <li>
                                    <a href="https://ayroui.com/" rel="nofollow noopner" target="_blank">
                                        <img src="landing/assets/images/footer/brands/ayroui.svg" alt="ayroui" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://ecommercehtml.com/" rel="nofollow noopner" target="_blank">
                                        <img src="landing/assets/images/footer/brands/ecommerce-html.svg"
                                            alt="ecommerce-html" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://graygrids.com/" rel="nofollow noopner" target="_blank">
                                        <img src="landing/assets/images/footer/brands/graygrids.svg"
                                            alt="graygrids" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://lineicons.com/" rel="nofollow noopner" target="_blank">
                                        <img src="landing/assets/images/footer/brands/lineicons.svg"
                                            alt="lineicons" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://uideck.com/" rel="nofollow noopner" target="_blank">
                                        <img src="landing/assets/images/footer/brands/uideck.svg" alt="uideck" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://tailwindtemplates.co/" rel="nofollow noopner" target="_blank">
                                        <img src="landing/assets/images/footer/brands/tailwindtemplates.svg"
