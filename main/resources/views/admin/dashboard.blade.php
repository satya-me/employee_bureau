            ...
            <div class="mdc-layout-grid__inner">
                <div
                    ...
                    <div class="mdc-card info-card info-card--success">
                        <div class="card-inner">
                            ...
                            <h5 class="font-weight-light pb-2 mb-1 border-bottom">{{ App\Models\FraudDB::count() }}</h5>
                ...
                <div
                    ...
                    <div class="mdc-card info-card info-card--danger">
                        <div class="card-inner">
                            <h5 class="card-title">Total Organization</h5>
                            <h5 class="font-weight-light pb-2 mb-1 border-bottom">{{ App\Models\User::count() }}</h5>
