                    ...
                    <nav class="mdc-list mdc-drawer-menu">
                        ...
                        <div class="mdc-list-item mdc-drawer-item">
                            ...
                            <div class="mdc-expansion-panel" id="ui-sub-menu">
                                <nav class="mdc-list mdc-drawer-submenu">
                                    <div class="mdc-list-item mdc-drawer-item">
                                        <a class="mdc-drawer-link" href="{{ url('admin/all_organization') }}">
                                            All Organisation
                                        </a>
                                    </div>
                                    <div class="mdc-list-item mdc-drawer-item">
                                        <a class="mdc-drawer-link" href="{{ url('admin/add_organization') }}">
                                            Add Organisation
                                        </a>
                                    </div>
                                </nav>
                        ...
                        <div class="mdc-list-item mdc-drawer-item">
                            ...
                            <div class="mdc-expansion-panel" id="sample-page-submenu">
                                <nav class="mdc-list mdc-drawer-submenu">
                                    <div class="mdc-list-item mdc-drawer-item">
                                        <a class="mdc-drawer-link" href="{{ route('admin.database') }}">
                                            Fraud List
                                        </a>
                                    </div>
                                    <div class="mdc-list-item mdc-drawer-item">
                                        <a class="mdc-drawer-link" href="{{ route('admin.add_database') }}">
                                            Add Fraud List
                                        </a>
                                    </div>
